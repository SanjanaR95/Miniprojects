# -*- coding: utf-8 -*-
"""Weather Forecasting with Machine Learning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kx6tBAnF8w2YhEaV-mn-Hf1YkP2Eh-mo
"""
...
# Upload Weather.csv into the current directory (Colab)
from google.colab import files
import os

print("Upload Weather.csv")
uploaded = files.upload()  # choose your local CSV

# If you uploaded with a different name, rename it to Weather.csv
if "Weather.csv" not in uploaded:
    for k in uploaded.keys():
        if k.lower().endswith(".csv"):
            os.rename(k, "Weather.csv")
            print(f"Renamed {k} -> Weather.csv")
            break

print("Ready: Weather.csv uploaded.")
...
"""Let’s see the foretasted data for 2018."""
